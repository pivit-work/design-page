...
const RESOURCE_DATA = {
  ...
  my: {
    ...
    // [답글 달기] 로 달리는 답글의 작성자(현재 사용자) — 데모는 어니스트.
    ...
    members: [
      {
        ...
        segments: [
          { pct: 47, color: 'var(--utility-success-200)', label: 'PIVIT V2.0 60%', tipColor: 'var(--utility-green-500)' },
          { pct: 33, color: 'var(--utility-blue-200)', label: '가천대 파일럿 60%', tipColor: 'var(--utility-blue-500)' },
        ],
        items: [
      ...
      },
      {
        ...
        segments: [
          { pct: 44, color: 'var(--utility-success-200)', label: '데이터 파이프라인 32%', tipColor: 'var(--utility-green-500)' },
          { pct: 24, color: 'var(--utility-blue-200)', label: 'PIVIT v2.0 30%', tipColor: 'var(--utility-blue-500)' },
          { pct: 18, color: 'var(--utility-purple-200)', label: 'IR 덱 준비 43%', tipColor: 'var(--utility-purple-500)' },
        ],
        items: [
    ...
    teams: [
      {
        ...
        // 세그먼트 컬러·hover 라벨은 시안 17478:23724 램프(green→blue→indigo→purple→fuchsia→pink).
        segments: [
          { pct: 20, color: 'var(--utility-success-200)', label: 'PIVIT V2.0 60%', tipColor: 'var(--utility-green-500)' },
          { pct: 17, color: 'var(--utility-blue-200)', label: '가천대 파일럿 60%', tipColor: 'var(--utility-blue-500)' },
          { pct: 13, color: 'var(--utility-indigo-200)', label: '온보딩 자동화 평균 16%', tipColor: 'var(--utility-indigo-500)' },
          { pct: 10, color: 'var(--utility-purple-200)', label: 'IR 덱 준비 평균 11%', tipColor: 'var(--utility-purple-500)' },
          { pct: 8, color: 'var(--utility-fuchsia-200)', label: '파트너 연동 평균 5%', tipColor: 'var(--utility-fuchsia-500)' },
          { pct: 5, color: 'var(--utility-pink-200)', label: '엔터프라이즈 세일즈 평균 3%', tipColor: 'var(--utility-pink-500)' },
        ],
        bullets: [
          { text: 'PIVIT V2.0 60%', color: 'var(--utility-green-500)' },
          { text: '가천대 파일럿 60%', color: 'var(--utility-blue-500)' },
          { text: '온보딩 자동화 평균 16%', color: 'var(--utility-indigo-500)' },
          { text: 'IR 덱 준비 평균 11%', color: 'var(--utility-purple-500)' },
          { text: '파트너 연동 평균 5%', color: 'var(--utility-fuchsia-500)' },
          { text: '엔터프라이즈 세일즈 평균 3%', color: 'var(--utility-pink-500)' },
        ],
        members: [
          { name: '박민준', role: 'BE', status: '여유', pct: 76, avatar: RS_AVATARS.박민준, segments: [{ pct: 33, color: 'var(--utility-success-200)', label: 'PIVIT V2.0 33%', tipColor: 'var(--utility-green-500)' }, { pct: 30, color: 'var(--utility-blue-200)', label: '가천대 파일럿 30%', tipColor: 'var(--utility-blue-500)' }] },
          { name: '신예은', role: 'BE', status: '적정', pct: 92, avatar: RS_AVATARS.신예은, segments: [{ pct: 54, color: 'var(--utility-success-200)', label: 'PIVIT V2.0 54%', tipColor: 'var(--utility-green-500)' }, { pct: 30, color: 'var(--utility-blue-200)', label: '가천대 파일럿 30%', tipColor: 'var(--utility-blue-500)' }] },
          { name: '오지후', role: 'BE', status: '적정', pct: 63, avatar: RS_AVATARS.오지후, segments: [{ pct: 24, color: 'var(--utility-success-200)', label: 'PIVIT V2.0 24%', tipColor: 'var(--utility-green-500)' }, { pct: 30, color: 'var(--utility-blue-200)', label: '가천대 파일럿 30%', tipColor: 'var(--utility-blue-500)' }] },
          { name: '최수빈', role: 'BE', status: '쏠림', pct: 98, avatar: RS_AVATARS.최수빈, segments: [{ pct: 33, color: 'var(--utility-success-200)', label: 'PIVIT V2.0 33%', tipColor: 'var(--utility-green-500)' }, { pct: 30, color: 'var(--utility-blue-200)', label: '가천대 파일럿 30%', tipColor: 'var(--utility-blue-500)' }, { pct: 27, color: 'var(--utility-error-200)', label: 'IR 덱 준비 27%', tipColor: 'var(--utility-error-500)' }] },
          { name: '김지안', role: 'BE', status: '쏠림', pct: 12, avatar: RS_AVATARS.김지안, segments: [{ pct: 33, color: 'var(--utility-success-200)', label: 'PIVIT V2.0 33%', tipColor: 'var(--utility-green-500)' }, { pct: 30, color: 'var(--utility-blue-200)', label: '가천대 파일럿 30%', tipColor: 'var(--utility-blue-500)' }, { pct: 27, color: 'var(--utility-error-200)', label: 'IR 덱 준비 27%', tipColor: 'var(--utility-error-500)' }] },
        ],
      },
      {
        ...
        sub: '투입인력 : 12/12명', overloaded: 0, missing: 0,
        segments: [
          { pct: 32, color: 'var(--utility-success-200)', label: 'PIVIT V2.0 60%', tipColor: 'var(--utility-green-500)' },
          { pct: 18, color: 'var(--utility-blue-200)', label: '가천대 파일럿 60%', tipColor: 'var(--utility-blue-500)' },
          { pct: 8, color: 'var(--utility-indigo-200)', label: '온보딩 자동화 평균 16%', tipColor: 'var(--utility-indigo-500)' },
          { pct: 6, color: 'var(--utility-purple-200)', label: 'IR 덱 준비 평균 11%', tipColor: 'var(--utility-purple-500)' },
          { pct: 4, color: 'var(--utility-fuchsia-200)', label: '파트너 연동 평균 5%', tipColor: 'var(--utility-fuchsia-500)' },
        ],
        bullets: [
          { text: 'PIVIT V2.0 60%', color: 'var(--utility-green-500)' },
          { text: '가천대 파일럿 60%', color: 'var(--utility-blue-500)' },
        ...
        members: [
          { name: '신예은', role: 'QA', status: '적정', pct: 92, avatar: RS_AVATARS.신예은, segments: [{ pct: 54, color: 'var(--utility-success-200)', label: 'PIVIT V2.0 54%', tipColor: 'var(--utility-green-500)' }, { pct: 30, color: 'var(--utility-blue-200)', label: '가천대 파일럿 30%', tipColor: 'var(--utility-blue-500)' }] },
          { name: '오지후', role: 'QA', status: '적정', pct: 63, avatar: RS_AVATARS.오지후, segments: [{ pct: 24, color: 'var(--utility-success-200)', label: 'PIVIT V2.0 24%', tipColor: 'var(--utility-green-500)' }, { pct: 30, color: 'var(--utility-blue-200)', label: '가천대 파일럿 30%', tipColor: 'var(--utility-blue-500)' }] },
        ],
      },
    ],
    directs: [
      { name: '어니스트', role: 'CPO', status: '과부하', pct: 56, avatar: RS_AVATARS.어니스트, segments: [{ pct: 47, color: 'var(--utility-success-200)', label: 'PIVIT V2.0 60%', tipColor: 'var(--utility-green-500)' }, { pct: 33, color: 'var(--utility-blue-200)', label: '가천대 파일럿 60%', tipColor: 'var(--utility-blue-500)' }] },
      { name: '조이안', role: 'ML', status: '과부하', pct: 56, avatar: RS_AVATARS.조이안, segments: [{ pct: 47, color: 'var(--utility-success-200)', label: '데이터 파이프라인 32%', tipColor: 'var(--utility-green-500)' }, { pct: 33, color: 'var(--utility-blue-200)', label: 'PIVIT v2.0 30%', tipColor: 'var(--utility-blue-500)' }] },
    ],
  },
};
