 ...
 */
export default function OkrPersonalCanvas({ data, icons, baseUrl = '', onKrUpdate }) {
    ...
    <div className="okr-personal-area">
      ...
      {periodTab === 'history' ? (
        ...
        <>
          ...
          <OkrBoard board={{ banner, insights, overall, theme, objectives }} icons={icons} baseUrl={baseUrl} onKrUpdate={onKrUpdate} />
        </>
      )}
    </div>
  );
