 ...
 */
export default function OkrStrategyCanvas({ rows: initialRows, companyBoard, history, icons, baseUrl = '', onKrUpdate, onSubmitFeedback, onViewAllFeedback, onSave, onAiAutocomplete, canEdit = true, onRefreshInsights, onInsightAction, onToggleInitiative, canEditInitiative = false }) {
  ...
  return (
    <div className="okr-personal-area">
      ...
      {subTab === 'canvas' ? (
        ...
        <OkrBoard board={companyBoard} icons={icons} baseUrl={baseUrl} onKrUpdate={onKrUpdate} onSubmitFeedback={onSubmitFeedback} onViewAllFeedback={onViewAllFeedback} onRefreshInsights={onRefreshInsights} onInsightAction={onInsightAction} onToggleInitiative={onToggleInitiative} canEditInitiative={canEditInitiative} />
